...
function testLinks()
{
	...
	{
		$_SESSION ['auth_button_clicked'] = 0;
        /*echo '<ul>
        ...
        if (XRO_APP_TYPE !== 'Private' && isset($_SESSION['access_token'])) {
            ...
            echo '<li><a href="http://localhost/wordpress/wp-admin/admin.php?page=xero-invoice/xero-invoice.php&authenticate=1">Authenticate</a></li>';
            echo '<li><a href="http://localhost/wordpress/wp-admin/admin.php?page=xero-invoice/xero-invoice.php&authenticate=2">Authenticate with Payroll API support (Australia & US organisations only)</a></li>';
        }
